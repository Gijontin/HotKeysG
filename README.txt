...
//square brackets i C# betyder att det är en "attribute", typ metadata som ändrar hur saken under ska bete sig (tex att det är C/C++ kodad metod från en dll fil utanför C#)
    ...
    private static extern bool RegisterHotKey(
        ...
        uint fsModifiers, //modifiers är bara alt/ctrl/shift/win och de skickar bara signal att de är nedtryckta "Keys" agerar som en "tru trigger" och är tänkt att aldrig vara någon av modifier-knapparna
        Keys vk
    );
...
//WindowProcess funktionen som lyssnar efter window/super-hoykey:n
