...
This program, if compiled (and not installed, no installation feature yet anyway), should be compatible all the way back to
Windows 2000.
...
display on the taskbar), which, by right-clicking and then selecting the "Configure Settings" option, will take you to the hotkey
binding menu.
...
- If the idle state of the program ever goes beyond its intended 7–10MB memory size, spit on it and then delete it from your PC —
  it doesn't even deserve to be called ASS if that happens.
